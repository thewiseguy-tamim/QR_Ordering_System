...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 flex items-center justify-between bg-white border-b border-gray-200 px-3 py-2">
      <div className="flex items-center gap-2">
        <Link to="/menu" className="font-extrabold tracking-tight">{APP.RESTAURANT_NAME}</Link>
